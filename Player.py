...
class Player(ABC):
    ...
    def move(self, board: Board) -> (GameResult, bool):
        """
        The player should make a move on board `board` and return the result.
        The return result can usually be passed on from the corresponding method in the board class.
    ...
    def final_result(self, result: GameResult):
        """
        This method will be called after the game has finished.
        It allows the player to ponder its game move choices
    ...
    # Additional method for printing purposes
    @abstractmethod
    def name(self):
        """
        Gives the name of this algorithm
        """
        pass

    # Additional method for creatihng a non-trained agent
    @abstractmethod
    def copy(self):
        pass
