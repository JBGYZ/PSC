...
class RndMinMaxAgent(Player):
    ...
    def __init__(self):
        ...
        """
        # `cache` now contains a list of best moves
        self.cache = {}
    ...
    def _min(self, board: Board) -> int:
        ...
        Notable changes with the `MinMaxAgent` are indicated with `#$`
        ...
        #
        # First we check if we have seen this board position before, and if yes just return a random choice from the cached values
        #
        ...
        # Choose randomly among the equally best moves
